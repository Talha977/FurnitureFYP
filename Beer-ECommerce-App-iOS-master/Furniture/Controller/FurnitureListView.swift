...
class FurnitureListView: UIViewController {
...
extension FurnitureListView:UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let furnitData = beerData[indexPath.section]
        cell.beerData = furnitData

        cell.beerImage.image = FurnitureModel.shared.Images[furnitData.ImageIndex]
//        cell.beerName.te = FurnitureModel.shared.Names[furnitData.ImageIndex]
...
extension FurnitureListView:UISearchBarDelegate{
...
extension FurnitureListView: INUIAddVoiceShortcutButtonDelegate {
...
extension FurnitureListView: INUIAddVoiceShortcutViewControllerDelegate {
...
extension FurnitureListView: INUIEditVoiceShortcutViewControllerDelegate {
